...
Java_main_Alpha_cifrar(JNIEnv *env, jobject obj, jstring senha, jstring confirmation, jstring inFileName, jstring outFileName, jint mode, jint size){
	...
	cifrador.cifrar(c_senha, c_confirmation, c_inFileName, c_outFileName, mode, size);
 ...
 */
extern "C" JNIEXPORT void JNICALL
Java_main_Alpha_decifrar(JNIEnv *env, jobject obj, jstring senha, jstring confirmation, jstring inFileName, jstring outFileName, jint mode, jint size){
	const char* c_senha = env->GetStringUTFChars(senha, 0);
	const char* c_confirmation = env->GetStringUTFChars(confirmation, 0);
	const char* c_inFileName = env->GetStringUTFChars(inFileName, 0);
	const char* c_outFileName = env->GetStringUTFChars(outFileName, 0);
	...
	decifrador.decifrar(c_senha, c_confirmation, c_inFileName, c_outFileName, mode, size);
