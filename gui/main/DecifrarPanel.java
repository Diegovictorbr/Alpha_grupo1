...
public class DecifrarPanel extends JPanel implements ActionListener {
	JFrame janela;
	JFileChooser chooser1 = new JFileChooser();
	JFileChooser chooser2 = new JFileChooser();
	JLabel label1 = new JLabel("Escolha o arquivo que deseja decifrar:");
	JLabel label2 = new JLabel("Escolha o diretorio para salvar o arquivo decifrado:");
	...
	JButton cifrarBtn = new JButton("Decifrar");
	...
	public DecifrarPanel(JFrame janela){
	...
	public void actionPerformed(ActionEvent e){
		...
		if(source.hashCode() == escolher1.hashCode()){
			...
			alpha.decifrar(String.valueOf(password.getPassword()),String.valueOf(confPassword.getPassword()),cifrarPath.getText(),cifradoPath.getText(), mode, size);
