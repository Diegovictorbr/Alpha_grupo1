...
//---------------------------------------------------------------------------
void  Cifrador::cifrar( const char* senha, const char* confirmationWord, const char* inputFile, const char* outputFile )
{
FILE *fr,*fw;
...
while(!feof(fr))
{
  ...
  //  msg  = new unsigned char[16];
   // msg = gerardorAleatorio->inserirAleatorizacao(msgWithoutRandom, ESQUERDA, _64BIT); //LINHA DO PROBLEMA*/
